...
var scene1 = new ScrollMagic.Scene({
    triggerElement: '.trigger1', // Phần tử trigger
    triggerHook: 0,//Vị trí bắt đầu của TriggerElement từ 0 -> 1 (ở đây là ".trigger1")
    duration: "100%",//Cảnh sẽ kéo dài trong scroll ("end").Khi scroll hết "End" thì sẽ dừng
})

    .setTween(tlFirstScroll) //Thêm Tween vào Scene
    .addIndicators() // Hiển thị thanh trigger
    .addTo(controller) // Gán Scene cho controller. (Bắt buộc)
...
var scene2 = new ScrollMagic.Scene({
    ...
    .setPin('.trigger2') // Ghim cho phàn tử scroll nếu "End" ở cuối khống scroll được nữa
    .addIndicators()
    .addTo(controller)
